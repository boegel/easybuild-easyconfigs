...
def get_target_branch():
    ...
    if not target_branch:
        return 'main' #raise RuntimeError("Did not find a target branch")
...
class EasyConfigTest(TestCase):
    ...
    def _get_changed_easyconfigs(self):
        ...
        changed_ecs_filenames = get_files_from_diff(diff_filter='M', ext='.eb')
        added_ecs_filenames = get_files_from_diff(diff_filter='A', ext='.eb')
    ...
    def _get_changed_patches(self):
        ...
        changed_patches_filenames = get_files_from_diff(diff_filter='M', ext='.patch')
        added_patches_filenames = get_files_from_diff(diff_filter='A', ext='.patch')
